...
M <- lmer(normalizedConcRatio ~ studyArm * visitMonth + (1 | patientID / visitMonth),
          data = df)
summary(M)
plot(ranef(M))
res <- residuals(M)
...
M <- lmer(normalizedConcGSH ~ studyArm * visitMonth + (1 | patientID / visitMonth),
          data = df)
summary(M)
plot(ranef(M))
res <- residuals(M)
...
M <- lmer(normalizedConcGSSG ~ studyArm * visitMonth + (1 | patientID / visitMonth),
          data = df)
summary(M)
plot(ranef(M))
res <- residuals(M)
